...
ACTIVE=['BLUEPRINT_BASELINE.md','docs/architecture/AERIS_UX_SKILL_EXAMPLES_V1.md','AGENTS.md','CLAUDE.md','README.md','constitution.md','aeris.policy.yaml','docs/AERIS_BLUEPRINT_ZH_TW.md','docs/governance/AI_READ_ORDER.md','docs/governance/AI_AUTOPILOT_SOP.md','docs/governance/ASTRA_EXECUTION_GATE_V3.md','docs/governance/CODEX_LOCAL_ONLY_WORKFLOW.md','docs/governance/GITHUB_ACCESS_BOUNDARY.md','docs/governance/AERIS_TRACEABILITY_MATRIX.md']
REQUIRED_IDS={'AERIS-UX-01','AERIS-UX-02','AERIS-EX-01','AERIS-EX-02','AERIS-EX-03','AERIS-AD-UI-001', 'AERIS-AD-D-001', 'AERIS-AD-SYNC-001', 'AERIS-AD-A-002', 'AERIS-AD-VERSIONS-001', 'AERIS-AD-SYNC-002', 'AERIS-AD-B-001', 'AERIS-AD-A-001', 'AERIS-AD-PROGRESS-001', 'AERIS-AD-ROOT-001', 'AERIS-AD-D-002', 'AERIS-AD-C-001', 'AERIS-AD-B-002', 'AERIS-AD-A-003', 'AERIS-AD-E-001', 'AERIS-AD-C-002'}
