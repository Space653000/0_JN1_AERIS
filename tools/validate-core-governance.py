...
ACTIVE=['docs/architecture/AERIS_UX_SKILL_EXAMPLES_V1.md','AGENTS.md','CLAUDE.md','README.md','constitution.md','aeris.policy.yaml','docs/AERIS_BLUEPRINT_ZH_TW.md','docs/governance/AI_READ_ORDER.md','docs/governance/AI_AUTOPILOT_SOP.md','docs/governance/ASTRA_EXECUTION_GATE_V3.md','docs/governance/CODEX_LOCAL_ONLY_WORKFLOW.md','docs/governance/GITHUB_ACCESS_BOUNDARY.md','docs/governance/AERIS_TRACEABILITY_MATRIX.md']
